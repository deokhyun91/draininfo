...
export default function Join(){
    ...
    <div className="loginBtnWrap">
            <h1 className='fs20 mb30 center'><Link  to="/login" className="loginH " >로그인</Link></h1>
            <h1 className='fs20 mb30 center'><Link to="/join" className="joinH pageOn">회원가입</Link></h1>
        </div>
     
        <div className="input_area">
           
            <input onBlur={() => checkid()} type="text" placeholder="id" ref={idRef} required/>
        </div>
        <div className="input_area">
